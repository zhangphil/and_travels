...
private void Login(){
	...
	/**
	String url = "http://172.16.0.11:8080/AndTravel/uservalidation/checkidentity/" + strPhoneNum + strPassword;
	                	 ...
	                	 if(response.getString("code").equals("1")){
	                		 ...
	                		 Intent intent=new Intent(mActivity, MainActivity.class);
	 		            	 mActivity.startActivity(intent);
	    	                	...
	    	                	Toast.makeText(LoginActivity.this, "用户名和密码不匹配，请更正！",Toast.LENGTH_SHORT).show();
	    	                }
	                }
	                catch(Exception e){
