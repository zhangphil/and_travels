...
public class PersonSettingFragment extends Fragment {
    ...
    private Integer[] imgeIDs = {R.drawable.talkhead,R.drawable.talkhead,R.drawable.talkhead,R.drawable.talkhead,R.drawable.talkhead,
    		R.drawable.talkhead};   
    private String[] titleNames = {"头像", "个人资料",    
            "昵称", "手机", "账号完全", "修改密码"};   
	    ...
	    listView.setOnItemClickListener( new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				// TODO Auto-generated method stub
				 if(position == 0){
					 //修改头像
					 //Intent intent=new Intent(mActivity, PersonSettingActivity.class);
			        ...
			        mActivity.startActivity(intent);
					 ...
					 //修改手机号
					 //Intent intent=new Intent(mActivity, ChangePhoneNumActivity.class);
				     //mActivity.startActivity(intent);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {   
            ...
            if (convertView == null) { 
            	...
            	switch(type){
	            	...
	            	case TYPE_2:{
	            		convertView = inflater.inflate(R.layout.personsetlist_item,  
	                            parent, false); 
	            		listItemView = new ListItemView();    
	            	...
	            	case TYPE_3:{
	            		convertView = inflater.inflate(R.layout.devide_line_person_set,  
	                            parent, false); 
	            		listItemView = new ListItemView();    
